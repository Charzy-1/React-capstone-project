  ...
  return (
    <div className="coin-page-container">
      ...
      <div className="coin-main-info">
        ...
        <h2 className="coin-price">${parseFloat(coinData.price_usd).toFixed(2)} USD</h2>
      ...
      <div className="coin-stats">
        ...
        <div className="stats-grid">
          <div className="stat-item">
            <span>% Change (24h):</span> <span>{coinData.percent_change_24h}%</span>
          </div>
          <div className="stat-item">
            <span>% Change (1h):</span> <span>{coinData.percent_change_1h}%</span>
          </div>
          <div className="stat-item">
            <span>% Change (7d):</span> <span>{coinData.percent_change_7d}%</span>
          </div>
          <div className="stat-item">
            <span>Market Cap $:</span> <span>{coinData.market_cap_usd}</span>
          </div>
          <div className="stat-item">
            <span>Volume (24h):</span> <span>{coinData.volume_24h_usd}</span>
          </div>
          <div className="stat-item">
            <span>Coin Supply:</span> <span>{coinData.circulating_supply}</span>
          </div>
        </div>
      </div>
    </div>
